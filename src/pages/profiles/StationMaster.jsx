...
import { MapPin, Search, ChevronLeft, ChevronRight, Save, X, Trash2, LogOut, Plus, Edit } from 'lucide-react';
...
const StationMaster = () => {
    ...
    const [records, setRecords] = useState([
        { id: 1, code: '001', name: 'LAHORE' },
        { id: 2, code: '002', name: 'KARACHI' },
        { id: 3, code: '003', name: 'ISLAMABAD' },
        { id: 4, code: '248', name: 'HARRPA' },
        { id: 5, code: '100', name: 'MULTAN' },
        { id: 6, code: '150', name: 'FAISALABAD' },
    ]);
    ...
    return (
        <div className={`space-y-6 text-text-main transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className="glass-card max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="px-6 py-4 border-b border-white/5 bg-gradient-to-r from-emerald-600/20 to-green-600/20">
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="col-span-3">
                            <input type="text" value={formData.name} onChange={(e) => handleInputChange('name', e.target.value)} disabled={isViewMode} className="w-full input-modern disabled:opacity-70" placeholder="Enter station name" />
                        </div>
                    </div>
                </div>
